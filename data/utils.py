...
def batch_align_structures(pos_1, pos_2, mask=None):
    ...
    pos_1 = pos_1.clone().half()
    aligned_pos_1 = torch.bmm(
        pos_1,
        align_rots
    )
    return aligned_pos_1, pos_2.clone().half(), align_rots.clone().half()
...
def align_structures(
    ...
    batch_positions=batch_positions.clone().double()
    ...
    return batch_positions_rotated, reference_positions, rotation_matrices.half()
